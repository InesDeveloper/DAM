...
$(document).ready(function(){
    ...
    $("section article").mouseout(function(){
     ...
     /*Cuando te encuentres con .px reemplazalo por nada, para que la cadena de caracteres se convierta en numero*/
    ...
    /*Creamos la variable este para poder introducir el this en el timeout*/
        var este = $(this)   
