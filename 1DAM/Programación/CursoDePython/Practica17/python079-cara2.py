...
imagen = Image.open("caras/cara1.jpeg")
pixeles = imagen.load()
...
# Voy a asumir que voy a coger el pixel que esta en cero //////// VERTICAL
...
# Voy a asumir que voy a coger el pixel que esta en cero //////// HORIZONTAL
for superx in range(0, 247):
    for supery in range(0, 247):
        suma = 0
        valor = 0
...
# Voy a asumir que voy a coger el pixel que esta en cero //////// DIAGONAL1
for superx in range(0, 247):
    for supery in range(0, 247):
        suma = 0
        valor = 0
...
print("El numero de pixeles diagonales1 es: "+str(numeropixelesdiagonales1))
# Voy a asumir que voy a coger el pixel que esta en cero //////// DIAGONAL1

# Voy a asumir que voy a coger el pixel que esta en cero //////// DIAGONAL2
for superx in range(0, 247):
    for supery in range(0, 247):
        suma = 0
        valor = 0
...
imagen.save("caras/cara1guardado.jpeg")
