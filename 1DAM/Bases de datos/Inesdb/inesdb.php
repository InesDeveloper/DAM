            ...
            switch($primerapalabra){
                case"CREATE":
                    ...
                    if($segundapalabra == "TABLE"){
                        ...
                        $myfile = fopen($tercerapalabra.".csv", "a") or die("Unable to open file!");
                ...
                case "INSERT":
                    ...
                    $myfile = fopen($tabla.".csv", "a") or die ("Unable to open file!");
