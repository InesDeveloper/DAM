...
<html>
    <head>
        ...
        /* ESTILOS DEL FORMULARIO DE LOGIN */
            ...
            .notice{position: absolute;top: 0px;width: 400px;background: red;color:azure;height: 20px;left: 50%;margin-left: -200px;padding: 10px;text-align: center;}
        ...
        /* ESTILOS DEL FORMULARIO */
            ...
            .campo input{padding: 5px;background: rgb(242, 242, 242);border: none;margin: 4px;width: 95%;clear: both;}
