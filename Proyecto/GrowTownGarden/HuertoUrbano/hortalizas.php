...
<body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
  ...
  <div class="site-wrap">
    ...
    ?>
      ...
      <div class="intro-section site-blocks-cover innerpage" style="background-image: url('images/hero_2.jpg');">
        <div class="container">
      ...
      <div class="site-section">
        <div class="container">
          <div class="row">
            ...
            <?php
                $peticion = "SELECT * FROM desplegable WHERE tipo='hortalizas'";
                $resultado = mysqli_query($enlace, $peticion);
                while ($fila = $resultado->fetch_assoc()) {
                    echo '
                    <div class="col-md-6 mb-5 mb-lg-5 col-lg-4">
              <div class="blog-entry">
                <a href="opciones.php?id='.$fila['id'].'&tipo='.$fila['nombre'].'" class="img-link">
                  <img src="'.$fila['imagen'].'" alt="Image" class="img-fluid">
                </a>
                <div class="blog-entry-contents">
                  <h3><a href="opciones.php?id='.$fila['id'].'&tipo='.$fila['nombre'].'">'.$fila['nombre'].'</a></h3>
                </div>
              </div>
            </div>
                    ';
