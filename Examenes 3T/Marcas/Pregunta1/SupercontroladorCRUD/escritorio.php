...
<link href="assets/dist/css/bootstrap.min.css" rel="stylesheet">
  ...
  <a class="navbar-brand col-md-3 col-lg-2 mr-0 px-3" href="#">Gestión empresa</a>
          ...
          <li class="nav-item">
            ...
            <?php
                ...
                while ($fila = $resultado->fetch_assoc()) {
                    ...
                    <a class="nav-link" href="?tabla= '.$fila['Tables_in_gestionempresa'].'">
                      <span data-feather="file"></span>
                      '.$fila['Tables_in_gestionempresa'].'
                    </a>
                  </li>
                    ';
                }
...
-->
        <ul class="nav flex-column mb-2">
           ...
           <?php
                ...
                $peticion = "SHOW FULL TABLES IN gestionempresa WHERE TABLE_TYPE LIKE 'VIEW'";
                $resultado = mysqli_query($enlace,$peticion);
