...
def guarda(nombre,telefono,email):
    ...
    cursor.execute("INSERT INTO contactos VALUES(NULL,'Jorge','123456789','jorge@correo.com');")
...
autor = Label(marco,text="Ines Martinez",fg="grey", font=("Arial,Verdana,sans-serif",16))
autor.pack(side=TOP)

foto = PhotoImage(file="fotobien.png",width=100,height=100)
