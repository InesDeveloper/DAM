...
<?php
            ...
            while ($fila = $resultado->fetch_assoc()) {
                echo '
                    <div class=mb-3">
                    <label for="address2" style="text-transform:uppercase;">'.$fila['Field'].' <span class="text-muted">(Optional)
                    </span></label>';
                /////////////////////////////////////////////////////////
                ...
                while ($fila2 = $resultado2->fetch_assoc()) {
                    echo '
                    <input type="text" name="'.$fila['Field'].'" class="form-control" id="address2"
                    value='.$fila2['columna'].'
                    ';
